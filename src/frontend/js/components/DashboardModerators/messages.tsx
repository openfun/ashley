...
export const messagesDashboardModerators = defineMessages({
  accessProfilModeratorTitle: {
    defaultMessage: "Access {userName}'s profil",
    description: "Title for the link to access a user's profil.",
    id: 'components.DashboardModerators.Moderator.accessProfilModeratorTitle',
  },
  addNewModerator: {
    defaultMessage:
