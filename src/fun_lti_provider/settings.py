"""This module contains default settings for fun_lti_provider application"""
...
# 2. The verifier LTI request (fun_lti_provider.lti.LTI)
#
...
settings.LTI_LAUNCH_SUCCESS_HANDLER = getattr(
    settings, "LTI_LAUNCH_SUCCESS_HANDLER", "fun_lti_provider.default.handlers.success"
)
...
settings.LTI_LAUNCH_FAILURE_HANDLER = getattr(
    settings, "LTI_LAUNCH_FAILURE_HANDLER", "fun_lti_provider.default.handlers.failure"
)
