...
TODO: externalize in an independant app (when stable)
"""
import re
...
from fun_lti_provider.models import LTIConsumer, LTIPassport

from .launch_params import LaunchParamException, LaunchParams
...
class LTI:
    ...
    def verify(self) -> bool:
        ...
        -------
        bool
            True if the LTI launch request is valid.
        """
